...
public class MCreatorDarkDirt extends shadowwolf_mod_one.ModElement {

	@GameRegistry.ObjectHolder("shadowwolf_mod_one:darkdirt")
	public static final Block block = null;

	public MCreatorDarkDirt(shadowwolf_mod_one instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("shadowwolf_mod_one:darkdirt",
				"inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			...
			setRegistryName("darkdirt");
			setUnlocalizedName("darkdirt");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(MCreatorDarkDirtMaterial.block, (int) (2)));
		}
	}
}
