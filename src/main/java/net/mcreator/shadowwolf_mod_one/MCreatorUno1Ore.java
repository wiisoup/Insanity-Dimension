...
public class MCreatorUno1Ore extends shadowwolf_mod_one.ModElement {

	@GameRegistry.ObjectHolder("shadowwolf_mod_one:uno1ore")
	public static final Block block = null;

	public MCreatorUno1Ore(shadowwolf_mod_one instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("shadowwolf_mod_one:uno1ore",
				"inventory"));
	}
	...
	public void generateWorld(Random random, int chunkX, int chunkZ, World world, int dimID, IChunkGenerator cg, IChunkProvider cp) {
		...
		for (int i = 0; i < 20; i++) {
			...
			int y = random.nextInt(125) + 3;
			int z = chunkZ + random.nextInt(16);
			(new WorldGenMinable(block.getDefaultState(), 26, new com.google.common.base.Predicate<IBlockState>() {
				...
				public boolean apply(IBlockState blockAt) {
					...
					if (blockAt.getBlock() == MCreatorRainbowBlock.block.getDefaultState().getBlock())
						blockCriteria = true;
					if (blockAt.getBlock() == MCreatorBenandroniteBlock.block.getDefaultState().getBlock())
						blockCriteria = true;
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.ROCK);
			setRegistryName("uno1ore");
			setUnlocalizedName("uno1ore");
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(MCreatorUno1Card.block, (int) (1)));
		}
	}
}
