...
public class MCreatorWoodAndOre extends shadowwolf_mod_one.ModElement {

	public static int DIMID = 3;
	public static final boolean NETHER_TYPE = false;
	@GameRegistry.ObjectHolder("shadowwolf_mod_one:insanity")
	public static final Item block = null;
	@GameRegistry.ObjectHolder("shadowwolf_mod_one:insanity_portal")
	public static final BlockCustomPortal portal = null;
	public static DimensionType dtype;

	public MCreatorWoodAndOre(shadowwolf_mod_one instance) {
		super(instance);
		instance.blocks.add(() -> new BlockCustomPortal());
		instance.items.add(() -> new ItemBlock(portal).setRegistryName(portal.getRegistryName()));
		instance.items.add(() -> new ModTrigger().setUnlocalizedName("insanity").setRegistryName("insanity"));
	}
	...
	public void preInit(FMLPreInitializationEvent event) {
		if (DimensionManager.isDimensionRegistered(DIMID)) {
			...
			System.err.println("Dimension ID for dimension insanity is already registered. Falling back to ID: " + DIMID);
		}
		dtype = DimensionType.register("insanity", "_insanity", DIMID, WorldProviderMod.class, true);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("shadowwolf_mod_one:insanity", "inventory"));
	}
	...
	public static class WorldProviderMod extends WorldProvider {
		...
		public void onPlayerAdded(EntityPlayerMP entity) {
			...
			int z = (int) entity.posZ;
			{
				...
				MCreatorInsanityDimensionPortalProcedure.executeProcedure($_dependencies);
			}
		}
	}
				...
				for (int j1 = -2; j1 <= 2; ++j1) {
					for (int k1 = -2; k1 <= 2; ++k1) {
						for (int l1 = -1; l1 < 3; ++l1) {
							...
							int k2 = k - j1;
							boolean flag = l1 < 0;
							this.world.setBlockState(new BlockPos(i2, j2, k2), flag ? Blocks.PLANKS.getDefaultState() : Blocks.AIR.getDefaultState());
						}
					}
				}
				...
				for (int l8 = 0; l8 < 4; ++l8) {
					for (int l9 = -1; l9 < 4; ++l9) {
						this.world.setBlockState(new BlockPos(i6 + (l8 - 1) * l6, k2 + l9, k6 + (l8 - 1) * i3),
								(l8 == 0 || l8 == 3 || l9 == -1 || l9 == 3) ? Blocks.PLANKS.getDefaultState() : iblockstate, 2);
					}
				}
	...
	public static class BlockCustomPortal extends BlockPortal {
		...
		public BlockCustomPortal() {
			setHardness(-1.0F);
			setUnlocalizedName("insanity_portal");
			setRegistryName("insanity_portal");
			setLightLevel(0F);
		}
		...
		public static class Size {
			...
			protected int getDistanceUntilEdge(BlockPos p_180120_1_, EnumFacing p_180120_2_) {
				...
				for (i = 0; i < 22; ++i) {
					...
					if (!this.isEmptyBlock(this.world.getBlockState(blockpos).getBlock())
							|| this.world.getBlockState(blockpos.down()).getBlock() != Blocks.PLANKS.getDefaultState().getBlock()) {
						break;
					}
				}
				Block block = this.world.getBlockState(p_180120_1_.offset(p_180120_2_, i)).getBlock();
				return block == Blocks.PLANKS.getDefaultState().getBlock() ? i : 0;
			}
			...
			protected int calculatePortalHeight() {
				label56 : for (this.height = 0; this.height < 21; ++this.height) {
					for (int i = 0; i < this.width; ++i) {
						...
						if (i == 0) {
							...
							if (block != Blocks.PLANKS.getDefaultState().getBlock()) {
								break label56;
							}
				...
				for (int j = 0; j < this.width; ++j) {
					if (this.world.getBlockState(this.bottomLeft.offset(this.rightDir, j).up(this.height)).getBlock() != Blocks.PLANKS
	...
	public static class ModTrigger extends Item {
		...
		public EnumActionResult onItemUse(EntityPlayer entity, World world, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY,
			...
			if (!entity.canPlayerEdit(pos, facing, itemstack)) {
				...
				{
					java.util.HashMap<String, Object> $_dependencies = new java.util.HashMap<>();
					MCreatorEnterAllDimensions1.executeProcedure($_dependencies);
				}
	...
	public static class GenLayerBiomesCustom extends GenLayer {
		...
		private Biome[] allowedBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("ocean")),
				Biome.REGISTRY.getObject(new ResourceLocation("desert")), Biome.REGISTRY.getObject(new ResourceLocation("mushroom_island")),
	...
	public static class ChunkProviderModded implements IChunkGenerator {
		...
		protected static final IBlockState STONE = Blocks.PLANKS.getDefaultState();
		protected static final IBlockState GRAVEL = Blocks.PLANKS.getDefaultState();
