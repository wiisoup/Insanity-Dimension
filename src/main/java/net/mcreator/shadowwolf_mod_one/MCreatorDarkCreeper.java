...
public class MCreatorDarkCreeper extends shadowwolf_mod_one.ModElement {

	public static final int ENTITYID = 20;
	public static final int ENTITYID_RANGED = 21;

	public MCreatorDarkCreeper(shadowwolf_mod_one instance) {
		super(instance);
		instance.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("shadowwolf_mod_one", "darkcreeper"), ENTITYID).name("darkcreeper").tracker(64, 1, true).egg(-26113, -65536)
				.build());
	}

	@Override
	public void init(FMLInitializationEvent event) {
		Biome[] spawnBiomes = {Biome.REGISTRY.getObject(new ResourceLocation("shadowwolf_mod_one:darkbiome")),};
		EntityRegistry.addSpawn(EntityCustom.class, 30, 1, 40, EnumCreatureType.CREATURE, spawnBiomes);
		DungeonHooks.addDungeonMob(new ResourceLocation("shadowwolf_mod_one:darkcreeper"), 180);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCreeper(), 0.5f) {
				...
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("shadowwolf_mod_one:textures/darkcreeper.png");
				}
			};
		});
	}
