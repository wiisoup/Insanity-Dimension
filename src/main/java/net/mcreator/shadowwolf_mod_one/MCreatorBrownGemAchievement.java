...
public class MCreatorBrownGemAchievement extends shadowwolf_mod_one.ModElement {

	public static final CustomAdvancementTrigger trigger = new CustomAdvancementTrigger();

	public MCreatorBrownGemAchievement(shadowwolf_mod_one instance) {
		super(instance);
	}
	...
	public static class CustomAdvancementTrigger implements ICriterionTrigger {
		...
		public ResourceLocation getId() {
			return new ResourceLocation("browngemachievement");
		}
