...
public class MCreatorDarkOre extends shadowwolf_mod_one.ModElement {

	@GameRegistry.ObjectHolder("shadowwolf_mod_one:darkore")
	public static final Block block = null;

	public MCreatorDarkOre(shadowwolf_mod_one instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("shadowwolf_mod_one:darkore",
				"inventory"));
	}
			...
			(new WorldGenMinable(block.getDefaultState(), 10, new com.google.common.base.Predicate<IBlockState>() {
				...
				public boolean apply(IBlockState blockAt) {
					...
					if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
						blockCriteria = true;
					if (blockAt.getBlock() == MCreatorDarkDirt.block.getDefaultState().getBlock())
						blockCriteria = true;
	...
	public static class BlockCustom extends Block {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(MCreatorDarkGem.block, (int) (1)));
		}
	}
}
