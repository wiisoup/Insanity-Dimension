...
public class MCreatorBestWeaponAchievement extends shadowwolf_mod_one.ModElement {

	public static final CustomAdvancementTrigger trigger = new CustomAdvancementTrigger();

	public MCreatorBestWeaponAchievement(shadowwolf_mod_one instance) {
		super(instance);
	}
	...
	public static class CustomAdvancementTrigger implements ICriterionTrigger {
		...
		public ResourceLocation getId() {
			return new ResourceLocation("bestweaponachievement");
		}
