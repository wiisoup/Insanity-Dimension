...
public class MCreatorRainbowCreeper extends shadowwolf_mod_one.ModElement {

	public static final int ENTITYID = 7;
	public static final int ENTITYID_RANGED = 8;

	public MCreatorRainbowCreeper(shadowwolf_mod_one instance) {
		super(instance);
		instance.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class)
				.id(new ResourceLocation("shadowwolf_mod_one", "rainbowcreeper"), ENTITYID).name("rainbowcreeper").tracker(64, 1, true)
				.egg(-256, -13369600).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		EntityRegistry.addSpawn(EntityCustom.class, 25, 2, 10, EnumCreatureType.MONSTER, spawnBiomes);
		DungeonHooks.addDungeonMob(new ResourceLocation("shadowwolf_mod_one:rainbowcreeper"), 180);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			return new RenderLiving(renderManager, new ModelCreeper(), 0.5f) {
				...
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("shadowwolf_mod_one:textures/color_creeper.png");
				}
			};
		});
	}
	...
	public static class EntityCustom extends EntityCreeper {
		...
		public EntityCustom(World world) {
			...
			this.targetTasks.addTask(7, new EntityAINearestAttackableTarget(this, MCreatorDimensionGuard.EntityCustom.class, true, true));
		...
		protected Item getDropItem() {
			return new ItemStack(MCreatorRainbowGunpowder.block, (int) (1)).getItem();
		}
